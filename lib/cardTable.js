...
CardTable.prototype.checkForBusts = function () {
  if (this.playerTotal > 21) {
    $('.message').text("You busted. Better luck next time!");
    return true;
}
...
//         $('.message').text("you lost, press reset to play again");
//     }
//     else if (this.dealerTotal === this.playerTotal) {
//         $('.message').text("it's a draw, press reset to play again");
//     }
//     else if (this.playerTotal === this.limit) {
//         $('.message').text("BLACKJACK! You won! Press reset to play again");
//     }
// }
